...
function sin(){
    const display=document.getElementById("result")
    display.value=Math.sin(display.value*(Math.PI/100))
}
function sinh(){
    const display=document.getElementById("result")
...
function cos(){
    const display=document.getElementById("result")
    display.value=Math.cos(display.value*(Math.PI/100))
}
function cosh(){
    const display=document.getElementById("result")
...
function tan(){
    const display=document.getElementById("result")
    display.value=Math.tan(display.value*(Math.PI/100))
}
function atan(){
    const display=document.getElementById("result")
...
function cot(){
    const display=document.getElementById("result")
    display.value=1/Math.tan(display.value*(Math.PI/100))
}
function coth(){
     const display=document.getElementById("result")
